(function () {
  ...
  angular.module('ng-highchartsservice', []).provider('HighChartsConfigService', HighChartsConfigService).factory('HighchartsService', HighchartService).factory('HighchartsServicePlugin', function () {
